...
import { PostReport, PostReportReasons, PostReportStatuses } from '@prisma/client';
import {
  IsDate,
  IsDefined,
  IsEnum,
...
export class PostReportEntity implements PostReport {
  @ApiProperty({
  ...
  @ApiProperty({ description: 'The post nested object for the post report' })
  post?: PostEntity;
}
