...
export class PostCommentReportEntity implements PostCommentReport {
  @ApiProperty({
  ...
  @ApiProperty({ description: 'The post comment nested object for the post comment report' })
