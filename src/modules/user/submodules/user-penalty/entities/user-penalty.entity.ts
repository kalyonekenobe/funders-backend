...
export class UserPenaltyEntity implements UserPenalty {
  @ApiProperty({
    description: 'User penalty uuid',
  ...
  @ApiProperty({
    description: 'User penalty creation date and time',
  ...
  @ApiProperty({
    description: 'User penalty last updated date and time',
    examples: [new Date('2024-01-03'), new Date('2023-11-02'), new Date('2023-06-30')],
    default: new Date('2024-01-03'),
  })
  @IsDate()
  ...
  @ApiProperty({ description: 'The nested object of status of the user penalty' })
  userPenaltyStatus?: UserPenaltyEntity;

  @ApiProperty({ description: 'The nested object of user of the user penalty' })
